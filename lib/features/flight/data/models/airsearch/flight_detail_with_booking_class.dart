...
class FlightDetailsWIthBookingClass {
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'bookingClasses': bookingClasses.map((x) => x.toMap()).toList()});
  ...
  factory FlightDetailsWIthBookingClass.fromMap(Map<String, dynamic> map) {
    return FlightDetailsWIthBookingClass(
      bookingClasses: List<BookingClass>.from(map['bookingClasses']?.map((x) => BookingClass.fromMap(x))),
  ...
  factory FlightDetailsWIthBookingClass.fromJson(String source) => FlightDetailsWIthBookingClass.fromMap(json.decode(source));
